...
@Component({
  selector: 'app-detail-findings-gabinet-complaint',
  templateUrl: './detail-findings-gabinet-complaint.component.html',
  styleUrls: ['./detail-findings-gabinet-complaint.component.scss']
})
export class DetailFindingsGabinetComplaintComponent implements OnInit {
  ...
  options = {
    ...
    file_picker_callback: (callback: any, value: any, meta: any) => {
      ...
      input.onchange = (event: Event) => {
        ...
        this.gestorService.uploadToS3(`${this.correlativo}/${createUID()}`, file as Blob).toPromise().then(res => {
